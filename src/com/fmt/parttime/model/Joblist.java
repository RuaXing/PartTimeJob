...
public class Joblist extends DataModel{ 
	...
	public String toString() {
		return "Joblist [jobID=" + jobID + ", jobTitle=" + jobTitle
				+ ", jobLat=" + jobLat + ", jobLon=" + jobLon
				+ ", jobPostAddress=" + jobPostAddress + ", jobPayFee="
				+ jobPayFee + ", jobPostDate=" + jobPostDate
				+ ", jobPostCompany=" + jobPostCompany + ", jobJSRQ=" + jobJSRQ
				+ ", jobZPRS=" + jobZPRS + ", jobGZRQ=" + jobGZRQ
				+ ", jobGZDZ=" + jobGZDZ + ", jobMSSJ=" + jobMSSJ
				+ ", jobMSDZ=" + jobMSDZ + ", jobZWMS=" + jobZWMS
				+ ", jobPhone=" + jobPhone + ", jobContactUser="
				+ jobContactUser + ", jobCity=" + jobCity + "]";
	} 
